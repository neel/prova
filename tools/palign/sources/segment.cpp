...
prova::loga::segment::segment(const std::string &base, index start, std::size_t length): _base(base), _start(start), _length(length) {}
...
const std::string &prova::loga::segment::base() const { return _base; }
...
std::string_view prova::loga::segment::view() const {
