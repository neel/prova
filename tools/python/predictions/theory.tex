...
\begin{eqnarray*}
	\begin{aligned}
	\Gamma(m_{1}, m_{2})\vert_{\phi, \psi} \coloneqq& \sigma\Bigg(\frac{m_{1}\phi \Big(m_{2}^{T}\psi\Big)^{T} }{\sqrt{u}}\Bigg) \in \mathbb{R}^{\eta\times \zeta} \\
	=& \mathcal{A}(m_{1}\phi, m_{2}^{T}\psi)
	\end{aligned}
\end{eqnarray*}
\end{tcolorbox}
