...
public:
    ...
    void bubble_all_pairwise(prova::loga::tokenized_alignment::matrix_type& mat, const_iterator base, std::size_t threshold = 1, bool ignore_indel = true, std::size_t threads = 0);
